...
if erisPLL_inventoryTooltip then
	if erisPLL_inventoryTooltip.versionNumber >= versionNumber then
		return;
	end;
end
...
erisPLL_inventoryTooltip.registerItem = function(_itemFullType, _modData, _label)
	erisPLL_inventoryTooltip.drawForItems[_itemFullType] = {
		modData = _modData,
		label = _label,
	};
end
...
erisPLL_inventoryTooltip.doOverride = function()
	...
	ISToolTipInv.render = function(self)
		...
		if not ISContextMenu.instance or not ISContextMenu.instance.visibleCheck then
			...
			if itemObj then
				local drawItem = erisPLL_inventoryTooltip.drawForItems[itemObj:getFullType()];
				if drawItem then
...
erisPLL_inventoryTooltip.init = function()
	erisPLL_inventoryTooltip.doOverride();
end

----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------

Events.OnGameStart.Add(erisPLL_inventoryTooltip.init);
