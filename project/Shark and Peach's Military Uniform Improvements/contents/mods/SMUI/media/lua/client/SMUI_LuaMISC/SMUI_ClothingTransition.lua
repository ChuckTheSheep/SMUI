local Functions = require "SMUI_ClothingTransition/DislaikFunctions"
...
local onClothingUpdated = function(source)
    ...
    Functions.replaceVisualClothing(source, "SMUIClothing.Trousers_ERDL", "SMUIClothing.Trousers_ERDLTucked",
    { "Shoes" },
    {   
